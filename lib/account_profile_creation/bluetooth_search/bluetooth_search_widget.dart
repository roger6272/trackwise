...
import 'bluetooth_search_model.dart';
export 'bluetooth_search_model.dart';
...
class BluetoothSearchWidget extends StatefulWidget {
  ...
  static String routeName = 'BluetoothSearch';
  static String routePath = '/bluetoothSearch';
...
class _BluetoothSearchWidgetState extends State<BluetoothSearchWidget>
  ...
  late BluetoothSearchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BluetoothSearchModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (widget!.isBTEnabled) {
        _model.isFetcingDevices = true;
        safeSetState(() {});
        _model.fetchedDevices = await actions.findDevices();
        _model.isFetcingDevices = false;
        _model.foundDevices =
