...
import 'item_update_page_model.dart';
export 'item_update_page_model.dart';

class ItemUpdatePageWidget extends StatefulWidget {
  const ItemUpdatePageWidget({
    super.key,
    required this.item,
  });
  ...
  static String routeName = 'ItemUpdatePage';
  static String routePath = '/itemUpdatePage';

  @override
  State<ItemUpdatePageWidget> createState() => _ItemUpdatePageWidgetState();
}

class _ItemUpdatePageWidgetState extends State<ItemUpdatePageWidget> {
  late ItemUpdatePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ItemUpdatePageModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<ItemRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final itemUpdatePageItemRecord = snapshot.data!;
                              ...
                              children: [
                                ...
                                TextFormField(
                                  controller:
                                    ...
                                    text: itemUpdatePageItemRecord.itemName,
                                  ),
                              ...
                              children: [
                                ...
                                TextFormField(
                                  controller: _model
                                      ...
                                      TextEditingController(
                                    text: itemUpdatePageItemRecord.incrementBy
                                        .toString(),
                                  ),
                                  focusNode:
                                      _model.textFieldIncrementByFocusNode,
                                  textInputAction: TextInputAction.next,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    hintText: '1',
                              ...
                              children: [
                                ...
                                FlutterFlowDropDown<String>(
                                  controller:
                                    ...
                                    _model.dropdownReminderValue ??=
                                        itemUpdatePageItemRecord.reminder,
                                  ),
                                  options: [
                                    'No Reminder',
                                    'Vibrate on Target',
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: FFButtonWidget(
                                onPressed: () async {
                                  if ((_model.textFieldItemNameTextController
                                              .text ==
                                          '') ||
                                    ...
                                    await itemUpdatePageItemRecord.reference
