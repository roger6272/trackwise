...
import 'schema/event_log_record.dart';
...
export 'schema/event_log_record.dart';
...
/// Functions to query EventLogRecords (as a Stream and as a Future).
Future<int> queryEventLogRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<EventLogRecord>> queryEventLogRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      EventLogRecord.collection,
      EventLogRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<EventLogRecord>> queryEventLogRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
