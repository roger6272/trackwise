...
class EventLogCumulativeChart extends StatefulWidget {
  final String range;
  final double width;
  final double height;
  ...
  @override
  _EventLogCumulativeChartState createState() =>
      _EventLogCumulativeChartState();
}

class _EventLogCumulativeChartState extends State<EventLogCumulativeChart> {
  int? selectedIndex;
  ...
  @override
  void didUpdateWidget(covariant EventLogCumulativeChart oldWidget) {
