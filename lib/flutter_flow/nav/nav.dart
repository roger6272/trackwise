...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? MainPageWidget() : Auth2CreateWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: BluetoothSearchWidget.routeName,
          path: BluetoothSearchWidget.routePath,
          builder: (context, params) => BluetoothSearchWidget(
        ...
        FFRoute(
          name: ItemSetupPageWidget.routeName,
          path: ItemSetupPageWidget.routePath,
          builder: (context, params) => ItemSetupPageWidget(),
        ),
        FFRoute(
          name: ItemUpdatePageWidget.routeName,
          path: ItemUpdatePageWidget.routePath,
          builder: (context, params) => ItemUpdatePageWidget(
        ...
        FFRoute(
          name: ConnectionInitiationWidget.routeName,
          path: ConnectionInitiationWidget.routePath,
          builder: (context, params) => ConnectionInitiationWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: ItemsListPage.routePath,
          builder: (context, params) => ItemsListPage(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => const ExportPage(),
        ),
        FFRoute(
