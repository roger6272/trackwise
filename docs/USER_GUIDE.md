...
You can pair up to **10** Traxelos One devices to your account, with up to **5 connected simultaneously**. When **two or more devices are connected simultaneously**, exclusive leasing activates automatically — each item is assigned to one device at a time.
